...
import torch
from transformer.SubLayers import MultiHeadAttention, PositionwiseFeedForward, FactorizedPositionwiseFeedForward
...
class EncoderLayer(nn.Module):
    ...
    def __init__(self, d_model, d_inner, n_head, d_k, d_v, factorized_k, dropout=0.1):
        ...
        self.pos_ffn = FactorizedPositionwiseFeedForward(d_model, d_inner, factorized_k, dropout=dropout)
